...
import org.polarsys.capella.cybersecurity.ui.activity.CreateThreatDiagramHyperlink;

public class PhysicalTDBActivityExplorerTestCase extends CyberDiagramActivityExplorerTestCase {

  @Override
  protected AbstractCapellaNewDiagramHyperlinkAdapter createLink() {
    return new CreateThreatDiagramHyperlink() {
      @Override
  ...
  protected ModelElement getTestModelElement() {
    return ((CreateThreatDiagramHyperlink) link).getModelElement(project);
  }
