...
public class Rule_CY_DCON_01_OA extends Rule_CY_DCON_01{

  @Override
  protected BlockArchitecture getArchitecture(CapellaModelSkeleton skeleton) {
    return skeleton.getOperationalAnalysis();
  }

  @Override
  protected AbstractFunction getFunction(BlockArchitecture architecture) {
    return ((OperationalAnalysis) architecture).getContainedOperationalActivityPkg().getOwnedOperationalActivities().get(0);
  }
