...
public class Asset__noThreat extends DynamicValidationTest {

  private static final String RULE = "org.polarsys.capella.cybersecurity.validation.asset__noThreat"; //$NON-NLS-1$
