...
import org.polarsys.capella.cybersecurity.ui.activity.PAPerformAutomatedTransitionAdapter;

public class CyberTransitionsFromLAActivityExplorerTestCase extends CyberTransitionsActivityExplorerTestCase {
  @Override
  protected AbstractHyperlinkAdapter createLink() {
    return new PAPerformAutomatedTransitionAdapter() {
      @Override
  ...
  protected EObject getStructure() {
    return context.getSemanticElement(LA__CYBERSECURITY_PKG);
  }
}
