...
/**
 * This is the item provider adapter for a {@link org.polarsys.capella.cybersecurity.model.CybersecurityPkg} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class CybersecurityPkgItemProvider extends NamedElementItemProvider implements IEditingDomainItemProvider,
   ...
   * @generated
   */
  public CybersecurityPkgItemProvider(AdapterFactory adapterFactory) {
  ...
  /**
   * This returns CybersecurityPkg.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  @Override
  public Object getImage(Object object) {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/CybersecurityPkg")); //$NON-NLS-1$
  }
  ...
  public String getText(Object object) {
    ...
    String label = ((CybersecurityPkg) object).getName();
    // begin-extension-code
    return label == null || label.length() == 0 ? "[" + getString("_UI_CybersecurityPkg_type") + "]" : label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    // end-extension-code
  }
  ...
  public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
    ...
    boolean qualify = childFeature == EmdePackage.Literals.EXTENSIBLE_ELEMENT__OWNED_EXTENSIONS
        || childFeature == CybersecurityPackage.Literals.CYBERSECURITY_PKG__OWNED_CYBERSECURITY_PKGS;
