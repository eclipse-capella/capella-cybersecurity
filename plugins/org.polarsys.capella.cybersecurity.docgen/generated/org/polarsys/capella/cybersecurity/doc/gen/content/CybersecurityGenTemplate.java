...
public class CybersecurityGenTemplate extends org.polarsys.capella.docgen.foundations.NamedElementDocGen {
	...
	protected void method_content(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		stringBuffer.append(CybersecurityHelper.getRealizedCapellaElement(element, htmlFolderName));
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return parameter instanceof PrimaryAsset || parameter instanceof Threat
				|| parameter instanceof CybersecurityPkg;
	}
}