...
public abstract class CyberLANewScenarioAdapter extends AbstractNewScenarioDiagramAdapter {

  @Override
  protected ModelElement getModelElement(EObject rootSemanticModel) {
    LogicalArchitecture logicalArchitecture = ModelQueryHelper.getLogicalArchitecture((Project) rootSemanticModel);
    return ScenarioCreationHelper.selectCapability((Project) rootSemanticModel, logicalArchitecture);
  }
}
