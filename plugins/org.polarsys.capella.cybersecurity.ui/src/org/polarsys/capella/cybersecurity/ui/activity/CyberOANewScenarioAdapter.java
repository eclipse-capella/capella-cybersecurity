...
public abstract class CyberOANewScenarioAdapter extends AbstractNewScenarioDiagramAdapter {

  @Override
  protected ModelElement getModelElement(EObject rootSemanticModel) {
    OperationalAnalysis operationalAnalysis = ModelQueryHelper.getOperationalAnalysis((Project) rootSemanticModel);
    return ScenarioCreationHelper.selectCapability((Project) rootSemanticModel, operationalAnalysis);
  }
}
