...
public interface CybersecurityFactory extends EFactory {
  ...
  /**
   * Returns a new object of class '<em>Pkg</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Threat</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Threat Involvement</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Function Storage</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Threat Application</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Primary Asset Storage</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Security Needs</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Trust Boundary Storage</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Functional Primary Asset</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Information Primary Asset</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Primary Asset Member</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
